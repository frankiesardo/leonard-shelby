...
Socratic dialogues. Each file captures a back-and-forth where the agent asked probing questions to surface the owner's actual positions, tensions, and open questions.
...
Spaced repetition cards extracted from sources and ideas. Generated by the `/save` skill.
