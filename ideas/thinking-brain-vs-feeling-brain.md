---
title: "Thinking Brain vs Feeling Brain"
aliases:
  - consciousness car
  - the clown car
...
The mind contains two systems: the Thinking Brain (conscious reasoning, calculation, language) and the Feeling Brain (emotions, impulses, intuition, instincts). The critical insight is that the Feeling Brain drives all action, not the Thinking Brain. Emotion is the biological hydraulic system that pushes our bodies into movement. Without it -- as Damasio's patient "Elliot" demonstrated after losing emotional capacity to a brain tumor -- even a brilliant mind cannot make decisions or function.
...
Haidt's [The Rider and the Elephant](the-rider-and-the-elephant.md) is the original version of this metaphor that Manson explicitly draws on. Haidt's key addition is the evolutionary argument: the rider evolved to *serve* the elephant, not to command it. And Damasio's brain-damaged patients prove the point -- without the elephant (emotion), even a brilliant rider (reason) cannot make decisions. See [The Happiness Hypothesis](../sources/books/the-happiness-hypothesis/summary.md).
